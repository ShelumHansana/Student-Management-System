...
{
    public partial class StudentNote : Form
    {
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                String Query = "INSERT INTO NoteStudent (Date,Note) VALUES ('" + dateTimePicker1.Value.Date.ToString() + "','" + txtnote.Text + "')";
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                String Select = "SELECT*FROM NoteStudent WHERE Date = '" + dateTimePicker1.Value.Date.ToString() + "'";
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        String DeleteQuery = "DELETE FROM NoteStudent WHERE Date='" + dateTimePicker1.Value.Date.ToString() + "'";
