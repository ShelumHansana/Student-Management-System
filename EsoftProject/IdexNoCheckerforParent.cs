...
{
    public partial class IdexNoCheckerforParent : Form
    {
        SqlConnection conn=new SqlConnection();
        public IdexNoCheckerforParent()
        {
            //connect database
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rdr.HasRows)
                {
                    ...
                    this.Hide();
                    AgreementforParent agreementforParent = new AgreementforParent();
                    agreementforParent.Show();
        ...
        private void IdexNoCheckerforParent_Load(object sender, EventArgs e)
        {
